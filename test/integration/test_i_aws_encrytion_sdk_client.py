...
class TestKMSThickClientIntegration(object):
    ...
    def test_encryption_cycle_aes_128_gcm_iv12_tag16_single_frame(self):
        ...
        ciphertext, _ = aws_encryption_sdk.encrypt(
            ...
            encryption_context=VALUES["encryption_context"],
            frame_length=1024,
            algorithm=AlgorithmSuite.AES_128_GCM_IV12_TAG16,
        )
        plaintext, _ = aws_encryption_sdk.decrypt(
            source=ciphertext, key_provider=self.kms_master_key_provider
        )
    ...
    def test_encryption_cycle_aes_192_gcm_iv12_tag16_single_frame(self):
        ...
        ciphertext, _ = aws_encryption_sdk.encrypt(
            ...
            encryption_context=VALUES["encryption_context"],
            frame_length=1024,
            algorithm=AlgorithmSuite.AES_192_GCM_IV12_TAG16,
        )
        plaintext, _ = aws_encryption_sdk.decrypt(
            source=ciphertext, key_provider=self.kms_master_key_provider
        )
    ...
    def test_encryption_cycle_aes_128_gcm_iv12_tag16_hkdf_sha256_single_frame(self):
        ...
        ciphertext, _ = aws_encryption_sdk.encrypt(
            ...
            encryption_context=VALUES["encryption_context"],
            frame_length=1024,
            algorithm=AlgorithmSuite.AES_128_GCM_IV12_TAG16_HKDF_SHA256,
        )
        plaintext, _ = aws_encryption_sdk.decrypt(
            source=ciphertext, key_provider=self.kms_master_key_provider
        )
    ...
    def test_encryption_cycle_aes_192_gcm_iv12_tag16_hkdf_sha256_single_frame(self):
        ...
        ciphertext, _ = aws_encryption_sdk.encrypt(
            ...
            encryption_context=VALUES["encryption_context"],
            frame_length=1024,
            algorithm=AlgorithmSuite.AES_192_GCM_IV12_TAG16_HKDF_SHA256,
        )
        plaintext, _ = aws_encryption_sdk.decrypt(
            source=ciphertext, key_provider=self.kms_master_key_provider
        )
    ...
    def test_encryption_cycle_aes_128_gcm_iv12_tag16_hkdf_sha256_ecdsa_p256_single_frame(
        self
    ):
        ...
        ciphertext, _ = aws_encryption_sdk.encrypt(
            ...
            encryption_context=VALUES["encryption_context"],
            frame_length=1024,
            algorithm=AlgorithmSuite.AES_128_GCM_IV12_TAG16_HKDF_SHA256_ECDSA_P256,
        )
        plaintext, _ = aws_encryption_sdk.decrypt(
            source=ciphertext, key_provider=self.kms_master_key_provider
        )
    ...
    def test_encryption_cycle_aes_192_gcm_iv12_tag16_hkdf_sha384_ecdsa_p384_single_frame(
        ...
        ciphertext, _ = aws_encryption_sdk.encrypt(
            ...
            encryption_context=VALUES["encryption_context"],
            frame_length=1024,
            algorithm=AlgorithmSuite.AES_192_GCM_IV12_TAG16_HKDF_SHA384_ECDSA_P384,
        )
        plaintext, _ = aws_encryption_sdk.decrypt(
            source=ciphertext, key_provider=self.kms_master_key_provider
        )
    ...
    def test_encryption_cycle_aes_192_gcm_iv12_tag16_hkdf_sha384_ecdsa_p384_non_framed(
        self
    ):
        """Test that the enrypt/decrypt cycle completes successfully for a single
    ...
    def test_encryption_cycle_aes_256_gcm_iv12_tag16_hkdf_sha384_ecdsa_p384_single_frame(
        self
    ):
        """Test that the enrypt/decrypt cycle completes successfully for a single
    ...
    def test_encryption_cycle_aes_256_gcm_iv12_tag16_hkdf_sha384_ecdsa_p384_non_framed(
        self
    ):
        """Test that the enrypt/decrypt cycle completes successfully for a single
