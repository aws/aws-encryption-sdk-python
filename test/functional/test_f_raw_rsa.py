...
from aws_encryption_sdk.structures import RawDataKey, EncryptedDataKey, MasterKeyInfo, KeyringTrace
...
_ENCRYPTION_MATERIALS = [
    ...
    #     encryption_context=_ENCRYPTION_CONTEXT,
    #     signing_key=_SIGNING_KEY,
    #     keyring_trace=KeyringTrace(wrapping_key=MasterKeyInfo(provider_id=_PROVIDER_ID, key_info=_KEY_ID),
