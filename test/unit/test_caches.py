        ...
        'encrypted_data_keys': [
            {
                'key': DataKey(
                    key_provider=MasterKeyInfo(
                        provider_id='this is a provider ID',
                        key_info=b'this is some key info'
                    ),
            ...
            },
            {
                'key': DataKey(
                    key_provider=MasterKeyInfo(
                        ...
                        key_info=b'this is some different key info'
                    ),
...
@pytest.mark.parametrize('encryption_context, result', [
...
@pytest.mark.parametrize('inner_request, result', [
    (
        dict(
...
@pytest.mark.parametrize('encrypted_data_keys, result', (
    (
