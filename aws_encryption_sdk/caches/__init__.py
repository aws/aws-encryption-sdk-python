...
from ..materials_managers import EncryptionMaterials, DecryptionMaterials
...
class CryptoMaterialsCacheEntry(object):
    ...
    def _update_with_message_bytes_encrypted(self, bytes_encrypted):
        ...
        with self._lock:
            ...
            super(CryptoMaterialsCacheEntry, self).__setattr__('bytes_encrypted', self.bytes_encrypted + bytes_encrypted)
