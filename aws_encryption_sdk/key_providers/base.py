...
from aws_encryption_sdk.exceptions import (
    MasterKeyProviderError, InvalidKeyIdError, DecryptKeyError,
    IncorrectMasterKeyError, ConfigMismatchError
)
...
class MasterKey(MasterKeyProvider):
    ...
    def __new__(cls, **kwargs):
        ...
        instance._encrypt_key_index = {instance.key_id: instance}
