...
VERSION = aws_encryption_sdk.internal.identifiers.SerializationVersion.V1
#: Default message structure Type as defined in specification
TYPE = aws_encryption_sdk.internal.identifiers.ObjectType.CUSTOMER_AE_DATA
#: Default algorithm as defined in specification
ALGORITHM = aws_encryption_sdk.internal.identifiers.Algorithm.AES_256_GCM_IV12_TAG16_HKDF_SHA384_ECDSA_P384
