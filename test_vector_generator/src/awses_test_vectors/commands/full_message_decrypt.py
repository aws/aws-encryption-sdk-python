...
def cli(args=None):
    ...
    parser.add_argument("--decrypt", type=argparse.FileType("r"), help="Existing full message decrypt manifest")

    parsed = parser.parse_args(args)

    decrypt_manifest = DecryptMessageManifest.from_file(parsed.decrypt)
