...
class HalfSigningEncryptionMaterialsFromMPL(EncryptionMaterialsFromMPL):
    """Allows overriding properties inside the EncryptionMaterialsFromMPL.
    The test vectors to this to "tamper" with the messages
    and ensure they fail with expected errors.
