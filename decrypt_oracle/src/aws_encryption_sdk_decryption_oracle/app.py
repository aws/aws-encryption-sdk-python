...
APP = Chalice(app_name="awses-encryption-oracle-python")
...
def basic_decrypt():
    ...
    try:
        ...
        return {"body": base64.b64encode(plaintext), "isBase64Encoded": True, "statusCode": 200}
    except Exception as error:  # pylint: disable=broad-except
        return {"body": str(error), "isBase64Encoded": False, "statusCode": 400}
